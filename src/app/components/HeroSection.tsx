        ...
        <div className="absolute bottom-8 right-4 sm:right-8 hidden md:block">
          ...
          >
            <div className="relative">
              {/* Hobbit Door */}
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-green-800 to-green-900 rounded-full relative shadow-xl border-4 border-amber-600 group-hover:shadow-2xl transition-all duration-300">
                {/* Door handle */}
              ...
              <div className="absolute bottom-full right-0 mb-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 pointer-events-none">
                <div className="bg-amber-900 text-amber-100 px-2 sm:px-3 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap shadow-xl border border-amber-700 max-w-xs">
                  <span className="hidden sm:inline">🧙‍♂️ &quot;There and Back Again: A Software Engineer&apos;s Tale&quot;</span>
                  <span className="sm:hidden">🧙‍♂️ My Journey</span>
              ...
              {/* Magic sparkles */}
              <div className="absolute -top-1 -right-1 w-2 h-2 sm:w-3 sm:h-3 bg-yellow-400 rounded-full opacity-0 group-hover:opacity-100 animate-ping transition-opacity duration-300"></div>
              <div className="absolute -bottom-1 -left-1 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-blue-400 rounded-full opacity-0 group-hover:opacity-100 animate-ping transition-opacity duration-300" style={{ animationDelay: '0.5s' }}></div>
            </div>
          </Link>
        </div>
      </section>
